<template>
  <div class="account top-border">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form :model="dialogData" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm" :disabled="dialogTitle==='详情'">
...
import { users, getUser, addUser, editUser, delUser } from "./api";
